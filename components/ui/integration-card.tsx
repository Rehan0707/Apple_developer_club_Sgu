...
const SwiftLogo = ({ className }: { className?: string }) => {
  return (
    <img
      src="/images/icon-swift.png"
      alt="Swift"
      className={cn("size-full rounded-xl object-cover", className)}
    />
  );
};

const SwiftUILogo = ({ className }: { className?: string }) => {
  return (
    <img
      src="/images/icon-swiftui.png"
      alt="SwiftUI"
      className={cn("size-full rounded-xl object-cover", className)}
    />
  );
